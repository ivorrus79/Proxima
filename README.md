...
*Установка*
скопировать файлы d175.pack, d177.pack, d178.pack, d179.pack into Warlock main directory.

*Удаление*
    delete d175.pack, d177.pack, d178.pack, d179.pack from Warlock main directory.
...
2. Великие маги (fractions.xml)
Было: 7 людей, 5 монстров, 3 нежити и только 1 эльф.
Стало: 4 людей, 4 монстров, 4 нежити и 4 эльфа.

3. Юниты и их перки (units.xml)
3.1 Поддержка
Все умения лечения у лекарей (послушницы/целительницы, шаманы и рыцари арети) получили дополнительный эффект очищения
3.2 Флот
All ships get +1 sight range, +30 melee defence, +30 shoot defence and now can upgrade to advanced versions, undead Caravelus can upgrade to Flying Galleus.
All advanced ships get +1 shoot range
...
3.3 Поселенцы
Settlers build time rised up to 3. Added "Быстроногий" perk

3.4 Исправлены цены улучшения
...
Healers
Useless levelup perk "Fear" replaces by perk_lvl_aura_blessing
Лекари лишены возможности приобретать железную броню, как и кастеры
...
- колдуны TODO получат барсиковский телепорт врага поближе и какую-нибудь отключалку, например, коатлевскую. 

2.1
Levelups:
Ужасному чудовищу / Cruel crature (lord_rabbit) полностью бесполезный перк "Маленькая цель" (+15 защиты от стрел) заменен на ауру подавления воли (-20% к силе окружающих врагов)
Перк "Маленькая цель" передан крысам взамен perk_lvl_learners

2.3 

2.4
Добавил нейтралам, диким и дремерам фракционный перк +1 опыт в ход. 

2.6
 [-] Лорд-кролик лишён +50 защиты к смерти и стихиям
 [+] Усилен лорд "Мастер меча"
...
Ужасному чудовищу бесполезный для него перк "Увертливость" (+15 защиты от ближнего боя и стрелкового урона) заменен на "Бешенство"
...
Chosen Warrior
Избранный воин		Bladewall => Avoidance
Finishers => Recon			
Ghost 
Призрак 	+Pathfinders	Pathfinders = > Mystery of Death (Resistance: +15      )
Avoidance => Strengthened Ghost (Unit power: +20%)			
Olden Ghost 
Издревний дух	+Pathfinders	Pathfinders = > Improved Mind Blast Mystery of Death (Adds action Mind Blast. Damage: 25  . Range: 2. Cooldown: 3)
Avoidance => Covert Vampire (Vampirism: 40%)			
Cruel creature
Аццкий кролик		Исправить перк "Маленькая цель"			
Мастер меча	Урон: 16 => 25, Hp: 40 => 50
Поддержка: золото 8 =>9, еда 4 => 6
+ перк "Известный герой", обычная броня заменена на улучшенную				
Магистру	великолепная броня (60 80 )замена на улучшенную (40 60				
Коатли 	   	3: => 			
...
4. Нанимаемые лорды (buildingtrees.xml)
Иногда случается, что за половину игры приходит всего один..два лорда, и те – чужой расы. Для исправления этой несправедливости сделана возможность нанять лорда как обычного юнита, но для его найма требуется здание на локальном ресурсе, например, на серебре и какое-нибудь обычное здание. Если лорд 
...
Если артефакт выдаётся при ключа дремер, то лорды-рукопашники (бойцы и звери) его получить могут, а вот дальнобойные (стрелки, колдуны и лекари) – нет. 
	Лорд	Слоты		Условия постройки	Цена
Люди
 	Мастер меча	Sword
Armor  
Amulet	Святая земля	Храм Крольма
Тренировочные площадки	700
 	Избранный воин		Алебардхолл	Военный университет
Тренировочные площадки	
 	Верховная целительница   	 	Магические поля	Волшебный сад
Гильдия клириков	250
 	Черный маг	 	Провал инферно	demonic lab 
Гильдия магов	250
		Sword
Armor  
Amulet			150
 	Сверхупрямый магистр	Sword
Armor  
Amulet	Ослы	Гильдия рыцарей, 
Кузница 	150
 	Дух королей	 Sword
Armor  
Amulet	святая земля	Храм Дауроса
Военная академия	2000
Нежить
 	Издревний дух	Sword
Sword
Amulet	тыквы	Нежить
Призрачные поля
Мельница душ	700
 	Верховный вампир   	Sword
Stave
Armor		Преобразователь
Гильдия вампиров	700
 	Король-скелет	 		training grounds Ancient Ruins 	700
Монстры
 	Просвещенный шаман	Stave
Armor
Amulet	Тыквы	Святилище тыквы
Гильдия шаманов	250
 
Elder Ogre	 	Свиньи	Свиноферма
Кабак	150
 
First Sharpshooter                	 	Алебардхолл	Военный университет ()
Кабак	150
 
Rat-prince  	Sword
Sword
Armor	Магические узлы	Сырная пещера
Кузница	150
 	Ужасное чудовище	 		Бойня 
Алхимическая лавка	700
 	Sart de Torvega	Armor
Amulet
Amulet		Гильдия волколаков 
Драконья ферма	2000
Эльфы
 	Лорд-хранитель	 		Адамантиновая лаборатория Chamber of arrows
Палата стрел	2000
 
Elven Bowmaster 	Bow
Amulet
Amulet		 Magic bazaar Elven Village 	700

 	Бес-советник	Sword
Stave
Amulet		university demonic lab 	700
 	Барсил	Sword
Amulet
Amulet		Trainings grounds demonic lab 	2000
 	Верховная ведьма	 		-	-
 	Верховный коатль	Stave
Stave
Amulet		university serpentarium	700
...
- Лук Робина Оксли (Obin Oxley's Bow)	Проходимость по лесам, Бонус в лесах,	*+25% урона жизни*
 	Броня Рорика
Rorik's Chain Mail	+40 защиты от ближнего боя
	+3 регенерация
 	Меч истины 
Sword of Truth	+10% урона ближнего боя
	+20% вампиризм, уровень 1→3
 	Драконья кольчуга
Dragonscale Hauberk	+40 защиты от ближнего боя
+20 защиты от стрел
	+30? Защиты от смерти
Уровень 2→3
 	Перчатка
Gauntlet of Death	+10% силы
+25 защиты от стихий
	Уровень 4→2
...
bld_a_dwarf_guild	perk_highlander «Горец», проходимость по холмам 	Цена 50, 
для Fighter, construct
bld_h_guild_ranger	perk_forester «Лесник», 	цена 50, для стрелков и лекарей
bld_a_elf_casino	perk_hit_and_run, 	цена 100, для caster, shooter
-1f -1m
...
bld_a_minotaur_training	+2r, 	Чтобы ИИ их строил 
доступен на 5ом уровне города
...
Ферма и Тыквоферма	+5% +5gr	
Свиноферма, Кабак, Бойня,
 Рыболовецкая деревня, 
Манаферма, Призрачные поля	+10% +10gr	
bld_m_cheese_cave	+15% +15gr	
bld_m_dragon_farm	+30% +30gr	
bld_m_shrine_pumpkin	+10%gr	
bld_u_guild_zombie	+5%gr	
Волшебный сад	+30% +30gr	
Порт		Вместо бонуса +50%g → +25%g +25%f
6. Квесты
5.1 Уменьшены награды и добавлены/увеличены штрафы за квесты. Штраф ~70% от награды. 
5.2 Добавлены квесты на постройку зданий,
5.3 В цели и награды божественных квестов добавлены юниты эльфов. Золото в наградах божественных квестов заменено на ману.
5.4 Food building quest gives settlers of random race
5.5 Mana/research building quest gives spells.
6.6 Добавлены цепочки квестов. По выполнению квеста в такой цепочке, сразу запускается новый квест
...
изменение заклинаний. Стоимость исследования заклинаний увеличена на +30%.
...
Spells modifying casting time are more powerful
